...
if (isset($_POST['areg_submit'])) {
    $_SESSION['aid'] = mysqli_escape_string($connection, $_POST['AID']);
    $_SESSION['afname'] = mysqli_escape_string($connection, $_POST['AFNAME']);
    $_SESSION['alname'] = mysqli_escape_string($connection, $_POST['ALNAME']);
    $_SESSION['aemail'] = mysqli_escape_string($connection, $_POST['AEMAIL']);
    $_SESSION['apassword'] = mysqli_escape_string($connection, md5($_POST['APASSWORD']));
    $_SESSION['aconfirm_password'] = mysqli_escape_string($connection, md5($_POST['ACPASSWORD']));
    $_SESSION['adistrict'] = mysqli_escape_string($connection, $_POST['ADISTRICT']);
    $_SESSION['aaadharnum'] = mysqli_escape_string($connection, $_POST['AAADHARNUM']);
    $_SESSION['otp'] = rand(10000, 99999);
    sendUserOtp($_SESSION['aemail'], $_SESSION['otp'], $_SESSION['afname'], $_SESSION['alname']);
        ...
        <div class="row justify-content-center align-items-center">
            ...
            <form name="myform" action="" method="POST" class="col-md-4 myform" style="margin: 30px 0px 0px 0px;"
                ...
                <div class="d-grid gap-2 inputs">
                    <input class="btn btn-success" type="submit" name="areg_submit" value="Get OTP">
                </div>
