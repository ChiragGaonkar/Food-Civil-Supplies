...
$aconfirm_password = $_SESSION['aconfirm_password'];
$adistrict = $_SESSION['adistrict'];
$aaadharnum = $_SESSION['aaadharnum'];
$otp = $_SESSION['otp'];

// INSERTING DATA
$aotp = mysqli_escape_string($connection, $_POST['AOTP']);
if (isset($_POST['areg_otp'])) {
    if ($otp == $aotp) {
        ...
        echo "<script>alert('Please enter a Correct')</script>";
    }
}
...
<body>
    ...
    <div class="container-fluid" style="background-color: #49d590; max-width: 100%; height:auto;">
        <div class="row justify-content-center align-items-center">
            <img src="images/AdminOTP.svg" class="col-md-4 img-fluid" alt="" style="margin: 100px 0px 0px 0px;">
            <form name="myform" action="" method="POST" class="col-md-4 myform" style="margin: 30px 0px 0px 0px;">
                <div class="form-group row">
                    <div class="input-group inputs" style="width: auto;">
                        ...
                        <input type="number" class="form-control" name="AOTP" required>
                    </div>
                </div>
                <div class="d-grid gap-2 inputs">
                    <input class="btn btn-success" type="submit" name="areg_otp" value="Register">
                </div>
            </form>
        </div>
        <div class=" row">
